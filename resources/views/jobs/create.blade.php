<x-app-layout>
    <div class="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <div class="border-b dark:border-gray-700 pb-4 mb-6">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Post a New Job</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Create a new job listing for your company</p>
        </div>
